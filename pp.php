...
<head>
  ...
  <title>Privacy Policy | RK Software Labs</title>
  <meta content="Privacy Policy RKSL" name="description">

  <meta content="pp" name="keywords">
...
<body>
  ...
  <?php
    ...
    if($_SERVER["REMOTE_ADDR"]!="103.226.147.218"):
    

  ?>

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-9KLBB1SY2W"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-9KLBB1SY2W');
</script>
...
<?php endif; ?>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php#values">Values</a></li>
  ...
  <main id="main" style="margin: 5em 0 0 0;">
    <!-- ======= About Section ======= -->
    <section id="tncsection" class="tncsection" style="padding: 3em 0; background-color: #4154f1;">

      <div class="container" data-aos="fade-up">
        
        <h1 class="section-title text-center text-light">Privacy Policy</h1>
    ...
    <section class="tatva-com-privacy-policy">
<div class="container">
<p>RK Software Labs ("us", "we", or "our") operates the <a href="https://www.rksoftwarelabs.tech/">www.rksoftwarelabs.tech</a> website and the mobile application (hereinafter referred to as the "Service").</p>
<p>Your privacy is important to us. RK Software Labs is committed to respect your privacy while using our website and mobile application. This Policy defines the requirements to ensure compliance with the applicable data privacy laws and regulations applicable to RK Software Labs’s collection, use, and transmission of Personal Data for information collected by us on our website.</p>
...
<li>
<h3>Services</h3>
<p>Service means the <a href="https://www.rksoftwarelabs.tech/">www.rksoftwarelabs.tech</a> website and the mobile application operated by RK Software Labs.</p>
</li>
<li>
<h3>Personal Data</h3>
...
<h2>4. Use of Data</h2>
<p>RK Software Labs uses the collected data for various purposes:</p>
<ul class="privacy-inner-listing">
...
<p>If you are from the European Economic Area (EEA), RK Software Labs legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
<p>RK Software Labs may process your Personal Data because:</p>
<ul class="privacy-inner-listing">
...
<p>RK Software Labs will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
<p>RK Software Labs will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>
</li>
<li>
...
<p>RK Software Labs will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
</li>
<li>
...
<p>RK Software Labs is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
</li>
<li>
<h3>Disclosure for Law Enforcement</h3>
<p>Under certain circumstances, RK Software Labs may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
</li>
<li>
<h3>Legal Requirements</h3>
<p>RK Software Labs may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul class="privacy-inner-listing">
<li>To comply with a legal obligation</li>
<li>To protect and defend the rights or property of RK Software Labs</li>
...
<li>
<h2>12. Your Data Protection Rights under the General Data Protection Regulation (GDPR)</h2>
<p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. RK Software Labs aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
...
<p><strong>The right to withdraw consent. </strong>You also have the right to withdraw your consent at any time where RK Software Labs relied on your consent to process your personal information.</p>
...
<li>
<h2>17. Contact Us</h2>
<p class="selectable">For any legal concern/question, please contact us on <a href="mailto:legal@rksoftwarelabs.tech">legal@rksoftwarelabs.tech</a></p>
</li>
</ul>
</div>
</section>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-4 col-md-12 col-sm-12 footer-info">
            <a href="index.php" class="logo d-flex align-items-center">
              <img src="assets/images/rkslLogo.png" alt="footerLogo" style="margin-left: -1.2em;">
            </a>
            <div class="social-links mt-3">
              <a href="https://twitter.com/rksoftwarelabs" class="twitter"><i class="bi bi-twitter"></i></a>
              <a href="https://www.instagram.com/rksoftwarelabs/" class="instagram"><i class="bi bi-instagram"></i></a>
              <a href="https://www.linkedin.com/company/80384059/admin/" class="linkedin"><i class="bi bi-linkedin"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-12 col-sm-12 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="tnc.php">Terms of service</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="pp.php">Privacy policy</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="rc.php">Refund Cancellation policy</a></li>
              <!-- <li><i class="bi bi-chevron-right"></i> <a href="tnc.html">Terms of service</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="pp.html">Privacy policy</a></li> -->
            </ul>
          </div>

          

          <div class="col-lg-4 col-md-12 col-sm-12 footer-contact text-center text-md-start">
            <h4>Contact Us</h4>
            <p>
              Mumbai, 
              India <br><br>
              <strong>Phone:</strong> +91 9137976398<br>
              <strong>Email:</strong> ratnesh@rksoftwarelabs.tech<br>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>RK Software Labs. 2022</span></strong>. All Rights Reserved
      </div>
